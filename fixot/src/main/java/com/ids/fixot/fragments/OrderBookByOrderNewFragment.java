...
import com.ids.fixot.adapters.StockOrderBookByOrderrecyclerNewAdapter;
...
public class OrderBookByOrderNewFragment extends Fragment  implements SwipeRefreshLayout.OnRefreshListener {
    ...
    StockOrderBookByOrderrecyclerNewAdapter adapter,secondAdapter;
    ...
    public OrderBookByOrderNewFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_order_book_by_order_new, null);
    }
    ...
    private void findViews() {
        ...
        if (MyApplication.lang == MyApplication.ENGLISH) {
            tvBidHeaderTitle.setText(getString(R.string.bid));
            tvAskHeaderTitle.setText(getString(R.string.ask));
        }

        // swipeContainer = getActivity().findViewById(R.id.swipeContainer);
        adapter =  new StockOrderBookByOrderrecyclerNewAdapter(getActivity() ,allOrdersFirst,false,false);
        llm = new LinearLayoutManager(getActivity());
        rvOrders.setLayoutManager(llm);
        rvOrders.setAdapter(adapter);

        swipeContainer = getActivity().findViewById(R.id.swipeContainerSecond);
        secondAdapter = new StockOrderBookByOrderrecyclerNewAdapter(getActivity() ,allOrdersSecond,true,false);
        ...
        protected void onProgressUpdate(String... values) {
            ...
            try {
                ...
                for (int i = 0; i < allOrders.size(); i++) {
                    ...
                    if (allOrders.get(i).getTradeType() == 1) {
                        allOrdersFirst.add(allOrders.get(i));
                    }
                    else if (allOrders.get(i).getTradeType() == 2) {
