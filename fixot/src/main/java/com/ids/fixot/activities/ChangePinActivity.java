...
public class ChangePinActivity extends AppCompatActivity implements MarketStatusListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Actions.initializeToolBar(getString(R.string.change_password), ChangePinActivity.this);
    ...
    private void findViews() {
        ...
        tvComplexPass.setVisibility(View.GONE);
/*        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                tvComplexPass.setText(Html.fromHtml(htmlString, null, new UlTagHandler2()));// setText(Html.fromHtml(htmlString));
            }
        } catch (Exception e) {
        ...
        btnUpdate.setOnClickListener(view -> {
            if (Actions.isNetworkAvailable(ChangePinActivity.this)) {
                if (etOldPass.getText().toString().trim().equals("") || etNewPass.getText().toString().trim().equals("") || etVerifyPass.getText().toString().trim().equals("")) {
                    Actions.CreateDialog(ChangePinActivity.this, getString(R.string.errorupdate), false, false);
                } else if (!etNewPass.getText().toString().equals(etVerifyPass.getText().toString())) {
                    Actions.CreateDialog(ChangePinActivity.this, getString(R.string.errorVerifyPin), false, false);
                }
                else /*if (IsValidPass())*/ {
                ...
                Actions.CreateDialog(ChangePinActivity.this, getString(R.string.no_net), false, false);
            }
        });
    }
    ...
    private class UpdatePasswordTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            MyApplication.showDialog(ChangePinActivity.this);
        }
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                stringer = new JSONStringer()
                        ...
                        .key("OldTradingPIN").value(Actions.MD5(Actions.MD5(oldPass) + random) + "")
                        .key("NewTradingPin").value(Actions.MD5(newPass) + "")
                        .endObject();
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (!status.equals("0")) {
                    ...
                    Toast.makeText(ChangePinActivity.this, MyApplication.lang == MyApplication.ENGLISH ? messageEn : messageAr, Toast.LENGTH_SHORT).show();
                    etOldPass.setText("");
                    etNewPass.setText("");
                    etVerifyPass.setText("");
                } else {
                    Toast.makeText(ChangePinActivity.this, getString(R.string.updatesuccessfulPin), Toast.LENGTH_SHORT).show();
         ...
         /*           MyApplication.editor.putString("etPassword", "").apply();
              ...
              /*      MyApplication.threadPoolExecutor = null;
                    ...
                    finishAffinity();
                    Intent i = new Intent(ChangePinActivity.this, LoginFingerPrintActivity.class);
                    startActivity(i);*/
                }
            } catch (JSONException e) {
                e.printStackTrace();
...
class UlTagHandler2 implements Html.TagHandler {
    @Override
