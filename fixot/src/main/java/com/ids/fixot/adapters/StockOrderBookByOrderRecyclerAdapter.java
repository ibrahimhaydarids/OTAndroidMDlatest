...
public class StockOrderBookByOrderRecyclerAdapter extends RecyclerView.Adapter<StockOrderBookByOrderRecyclerAdapter.ViewHolder> {
    ...
    public StockOrderBookByOrderRecyclerAdapter(Activity context, ArrayList<StockOrderBook> allOrdersp, boolean second,boolean byPrice) {
    ...
    public StockOrderBookByOrderRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View v;
        if(second)
           v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.order_book_by_order_second, viewGroup, false);
        else
