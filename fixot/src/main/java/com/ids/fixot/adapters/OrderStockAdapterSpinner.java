...
public class OrderStockAdapterSpinner extends ArrayAdapter<enums.TradingSession> {
    ...
    public OrderStockAdapterSpinner(Activity applicationContext, ArrayList<String> filter) {
