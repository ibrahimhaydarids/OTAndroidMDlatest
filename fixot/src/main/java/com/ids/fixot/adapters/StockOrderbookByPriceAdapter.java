...
public class StockOrderbookByPriceAdapter extends RecyclerView.Adapter<StockOrderbookByPriceAdapter.ViewHolder> {
    ...
    public StockOrderbookByPriceAdapter(Activity context, ArrayList<StockOrderBook> allOrdersp, boolean second,boolean byPrice) {
    ...
    @Override
    public StockOrderbookByPriceAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View v;
        v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.order_book_by_order_item, viewGroup, false);
        return new StockOrderbookByPriceAdapter.ItemViewHolder(v);
    }
