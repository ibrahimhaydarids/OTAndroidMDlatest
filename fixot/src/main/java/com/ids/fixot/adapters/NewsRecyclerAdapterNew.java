...
public class NewsRecyclerAdapterNew extends RecyclerView.Adapter<NewsRecyclerAdapterNew.RecyclerViewHolder> {

    private ArrayList<NewsItem> news;
    private Activity context;

    public NewsRecyclerAdapterNew(Activity context, ArrayList<NewsItem> newss) {
        this.news = newss;
